...
declare namespace TcHmi.Controls.Beckhoff {
    class TcHmiPermissionManagement extends TcHmi.Controls.System.TcHmiControl {
        ...
        private __updateSymbolSearch;
        /**
         * If raised, all attributes have been set to it's default or dom values.
         * This function is only to be used by the System. Other function calls are not intended.
         */
        __init(): void;
        private __fetchRecursiveFiles;
        static recordToMap<K extends string | number, V>(record: Record<K, V>): Map<K, V>;
        private __cached_results;
        private __subscriptionCallback;
        private __removePreviousGenericElements;
        private __createGroupHeader;
        private __createGroupDefaultAccessElements;
        private __allSymbolsChangeCallback;
        private __createGroupAllResourcesElements;
        private __onInheritCheckboxChange;
        private __removeAccessFromResources;
