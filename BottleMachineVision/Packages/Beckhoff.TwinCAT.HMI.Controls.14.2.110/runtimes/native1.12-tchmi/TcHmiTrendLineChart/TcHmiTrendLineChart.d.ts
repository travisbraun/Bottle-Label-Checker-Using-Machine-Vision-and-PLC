declare namespace TcHmi.Controls.Beckhoff {
    class TcHmiTrendLineChart extends TcHmi.Controls.System.TcHmiControl {
        ...
        protected __lineGraphDescriptionInternal: TcHmiTrendLineChart.LineGraphDescriptionInternal[] | null;
        /** Only barGraphDescriptions that have been selected from __lineGraphDescriptions as an array of TcHmiTrendLineChart.LineGraphDescription or null */
        protected __lineGraphDescriptionSelected: TcHmiTrendLineChart.LineGraphDescriptionInternal[] | null | undefined;
        ...
        private __onPressedSettingsDestroyEvent;
        ...
        private __onPressedSettingsDialogOkEvent;
        private __onPressedSettingsDialogCancelEvent;
         ...
         */
        private __getTimeComboboxHandler;
...
declare namespace TcHmi.Controls.Beckhoff.TcHmiTrendHelpers {
    class TcHmiTrendHelper {
        /**
         * Check if the string is a Datetime
         */
        static isDatetime(date: string | null | undefined): date is string;
        /**
         * Check if the string is a keyWord (Latest, First)
         */
        static isKeyword(keyword: string | null): keyword is string;
        /**
         * Check if the string is a timespan
         */
        static isTimespan(timespan: string | null | undefined): timespan is string;
        /**
         * Convert milliseconds to iso 8601 string
         * @param milliSec Milliseconds
         */
        static __milliSecToIso(milliSec: number): string;
        /**
         * Convert iso 8601 string to milliseconds
         * @param t Iso 8601 string
         */
        static __isoToMilliSec(t: string): number;
    }
}
