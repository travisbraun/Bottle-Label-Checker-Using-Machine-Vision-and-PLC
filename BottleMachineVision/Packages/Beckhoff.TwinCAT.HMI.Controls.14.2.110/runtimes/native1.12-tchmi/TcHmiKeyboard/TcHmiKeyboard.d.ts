...
declare namespace TcHmi.Controls.Beckhoff.TcHmiKeyboardHelpers {
    export class InputHints {
         ...
         */
        update(focusedElement: HTMLInputElement | HTMLTextAreaElement): void;
        /**
         * Removes the hints from the DOM.
         */
        hide(): void;
        /**
    ...
    abstract class InputHint {
        ...
        /**
         * Set the value of this input hint and wtite it to the DOM. Also hides or shows the hint.
