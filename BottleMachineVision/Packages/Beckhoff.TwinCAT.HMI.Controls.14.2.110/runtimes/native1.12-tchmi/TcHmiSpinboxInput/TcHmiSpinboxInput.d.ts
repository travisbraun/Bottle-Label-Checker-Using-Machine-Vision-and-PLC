declare namespace TcHmi.Controls.Beckhoff {
    class TcHmiSpinboxInput extends TcHmi.Controls.Beckhoff.TcHmiNumericInput {
        ...
        protected readonly __evtHandlerPointerClickPlus: (this: void, e: MouseEvent) => void;
        protected readonly __evtHandlerPointerClickMinus: (this: void, e: MouseEvent) => void;
        protected readonly __evtHandlerPointerDownPlus: (this: void, e: MouseEvent) => void;
        protected readonly __evtHandlerPointerDownMinus: (this: void, e: MouseEvent) => void;
        protected readonly __evtHandlerDocumentPointerUp: (this: void, e: MouseEvent) => void;
        protected readonly __evtHandlerContextMenu: (event: Event) => void;
         ...
         **/
        protected __onButtonPlus(): (evt: MouseEvent) => void;
        /**
         * Eventhandler for the minus button
         **/
        protected __onButtonMinus(): (evt: MouseEvent) => void;
        /**
         * Eventhandler for the plus button PointerDown
         **/
        protected __onPointerDownButtonPlus(): (evt: MouseEvent) => void;
        /**
         * Eventhandler for the minus button PointerDown
         **/
        protected __onPointerDownButtonMinus(): (evt: MouseEvent) => void;
        /**
